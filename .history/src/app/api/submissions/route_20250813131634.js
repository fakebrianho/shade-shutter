				...
				try {
					...
					return {
						...
						cloudinaryInfo: folderContents.success ? {
							resourceCount: folderContents.resources.length,
							resources: folderContents.resources.map(resource => ({
					...
					console.error(`Error enhancing submission ${submission.submissionId}:`, error)
					return submission
				}
			})
		)
